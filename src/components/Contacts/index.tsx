          ...
          <ContactsCards>
            <ContactCard>
              ...
              <ContactCardContent>
                ...
                <Text color="grey2" type="body2">
                  Estou disponível para um chat, vamos conversar ?
                </Text>
                <Text
                  as="a"
                  color="grey2"
            ...
            <ContactCard>
              ...
              <ContactCardContent>
                ...
                <Text color="grey2" type="body2">
                  Me envie um email para feedbacks, sugestões e idéias
                </Text>
                ...
                <Text
                  ...
                  onClick={() =>
                    (window.location.href = "mailto:vgb1337@gmail.com")
                  }
                >
                  Me mande um email
                </Text>
            ...
            <ContactCard>
              ...
              <ContactCardContent>
                ...
                <Text color="grey2" type="body2">
                  Vamos expandir nosso Network ? Adicione-me no LinkedIn
                </Text>
                <Text
                  as="a"
                  color="grey2"
